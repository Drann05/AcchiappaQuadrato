...
class Menu_principale:
    ...
    def build_ui(self):
        title = self.parent.addLabel(" ACCHIAPPA QUADRATO\n\nMAIN MENU", row=2, column=6, columnspan=2)
        ...
        btn_quit = self.parent.addButton("Quit", row=6, column=4, columnspan=4, command=self.parent.quit)
        self.style(btn_quit)
